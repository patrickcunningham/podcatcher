...
public class PodcastDAO extends SQLiteOpenHelper {
	...
	public void addSite(Podcast podcast) {
		...
		values.put(KEY_TITLE, podcast.getTitle()); // site title
		values.put(KEY_LINK, podcast.getLink()); // site url
		values.put(KEY_RSS_LINK, podcast.getRssLink()); // rss link url
		values.put(KEY_DESCRIPTION, podcast.getDescription()); // site description
	...
	public List<Podcast> getAllSites() {
		List<Podcast> siteList = new ArrayList<Podcast>();
		// Select All Query
